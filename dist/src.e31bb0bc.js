...
var config = {
  API_HOST: "http://127.0.0.1:8000" || 'http://51.222.30.188:8000' // API_HOST: process.env.API_HOST || 'http://127.0.0.1:8000'
...
exports.addEventForLinksWhite = exports.addEventForLinksDjump = exports.addEventForLinks = void 0;
...
var addEventForLinksDjump = function addEventForLinksDjump(link) {
...
exports.addEventForLinksDjump = addEventForLinksDjump;
var linksDjump = document.querySelectorAll('.cursor_jump');
var linksDjumpWhite = document.querySelectorAll('.cursor_jump_white');
var linksDjumpBlack = document.querySelectorAll('.cursor_jump_black');
linksDjump.forEach(function (link) {
  addEventForLinksDjump(link);
});
linksDjumpWhite.forEach(function (link) {
  addEventForLinksDjump(link, 'white');
});
linksDjumpBlack.forEach(function (link) {
...
var linksEvents = function linksEvents(card) {
  ...
  var linksDjump = card.querySelectorAll('.cursor_jump');
  linksDjump.forEach(function (link) {
    (0, _cursor.addEventForLinksDjump)(link);
  });
