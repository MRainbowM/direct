...
burger.addEventListener('click', function (e) {
  ...
  if (isShowMenu) {
    ...
    document.body.style.overflow = "visible"; //скрыть форму
...
var btnSend = document.querySelector('.menu_form_send');
...
footerBtn.addEventListener('click', scrollToStart); // TODO: скролл по ссылкам в меню
...
menuLinks.forEach(function (link) {
  ...
  link.addEventListener('click', function (e) {
    ...
    var scrollPoint = section.offsetTop;
...
var peoplesBtn = document.querySelector('.btn_peoples'); // TODO: скролл к форме в меню
